                  ...
                  {goals.map((goal) => {
                    ...
                    return (
                      <button
                        ...
                        className={`bg-white dark:bg-slate-800 rounded-2xl p-5 border shadow-sm text-left transition-all group ${
                          isCompleted 
                      ...
                      >
                        ...
                        {goal.targetDate && !isCompleted && (
                          <div className="mt-2 flex items-center gap-1 text-xs text-slate-400">
                            ...
                            {new Date(goal.targetDate).toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US', { day: 'numeric', month: 'short', year: 'numeric' })}
                          </div>
                        )}
                      </button>
                    );
              ...
              <>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-100 dark:border-slate-700 shadow-sm">
                  ...
                  <div className="mt-4 flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    {l.estimatedDate}: {new Date(plan.projectedCompletion).toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US', { day: 'numeric', month: 'long', year: 'numeric' })}
                  </div>
                </div>
                        ...
                        <div key={milestone.percentage} className="flex items-start gap-4 relative">
                          ...
                          <div className="flex-1 pb-4">
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                              {milestone.isCompleted 
                                ? l.achieved
                                : `${l.projected}: ${new Date(milestone.projectedDate).toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US', { day: 'numeric', month: 'short' })}`
                              }
                            </p>
                          </div>
                        </div>
