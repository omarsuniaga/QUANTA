...
export const ExpensesScreen: React.FC<ExpensesScreenProps> = ({
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20">
      {/* Header */}
      <div className="bg-gradient-to-br from-rose-500 to-rose-600 dark:from-rose-600 dark:to-rose-700 p-6 pb-8">
        <h1 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
          <ArrowDownRight className="w-7 h-7" />
          Mis Gastos
        </h1>
        <p className="text-rose-100 text-sm">Controla tu dinero que sale</p>
      </div>
      ...
      <div className="px-4 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-600 hover:to-rose-700 text-white font-bold py-4 px-6 rounded-2xl transition-all shadow-xl shadow-rose-200 dark:shadow-none mb-3"
        >
          <Zap className="w-6 h-6" />
          <span className="text-lg">Gasto Rápido</span>
        </button>

        <div className="grid grid-cols-2 gap-3">
          <button
            onClick={onRecurringExpense}
            className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-indigo-200 dark:shadow-none"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-purple-200 dark:shadow-none"
          >
      ...
      <div className="px-4 mb-6">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-bold text-slate-700 dark:text-slate-300 uppercase tracking-wide flex items-center gap-2">
        ...
        {todayExpenses.length === 0 ? (
          <div className="bg-slate-50 dark:bg-slate-800 rounded-xl p-6 text-center">
            <Coffee className="w-12 h-12 mx-auto mb-3 text-slate-300 dark:text-slate-600" />
          ...
          <div className="space-y-2">
            ...
            <button
              ...
              className="w-full text-center py-2 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:underline"
            >
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 ml-10">
                ...
                <div className="flex items-center gap-2 mt-3 pt-3 border-t border-slate-100 dark:border-slate-700">
                  <div className="flex-1 flex items-center gap-1.5 text-xs text-indigo-600 dark:text-indigo-400">
                    <Bell className="w-3.5 h-3.5" />
                    <span>Próximo: {getNextChargeDate(new Date(expense.date).getDate())}</span>
                  </div>
      ...
      {budgetUsedPercent >= 90 && (
        <div className="px-4 mb-6">
          <div className="bg-rose-50 dark:bg-rose-900/30 border border-rose-200 dark:border-rose-800 rounded-xl p-4 flex items-start gap-3">
            <AlertCircle className="w-5 h-5 text-rose-500 flex-shrink-0 mt-0.5" />
            <div>
              <h3 className="font-bold text-rose-900 dark:text-rose-100 text-sm mb-1">
