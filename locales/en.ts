...
export const en: TranslationKeys = {
  ...
  dashboard: {
    ...
    oracleHelpTitle: 'What is the Financial Oracle?',
    oracleHelpContent: 'The Financial Oracle shows you a projection of your balance at the end of the month, automatically calculating your pending recurring expenses (subscriptions, services, bills). This helps you plan your finances better and avoid surprises before month-end.',
    oracleHelpTip: '💡 Tip: Register all your recurring services for more accurate projections.',
    gotIt: 'Got it',
